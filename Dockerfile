...
COPY --from=deps /glee/src/app/node_modules ./node_modules
COPY . .
...
COPY --from=builder /glee/src/app/public ./public
COPY --from=builder --chown=nextjs:nodejs /glee/src/app/.next/standalone ./
COPY --from=builder --chown=nextjs:nodejs /glee/src/app/.next/static ./.next/static
